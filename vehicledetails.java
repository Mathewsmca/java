...
class Vehicle{
	public static void main(String[] args){
		...
		vehicleDetails[0]= new VehicleDetails("BMW","BMW X5", 10001,3200000);
		vehicleDetails[0].details();
		
		vehicleDetails[1]= new VehicleDetails("Mercedes","Mercedes Benz s-Class", 10002,45000000);
		vehicleDetails[1].details();
		
		vehicleDetails[2]= new VehicleDetails("Jaguar","Jaguar XF",10003,6670000);
